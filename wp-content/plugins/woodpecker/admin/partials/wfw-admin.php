...
<div id="woodpecker-options" class="woodpecker-options-wrap">
    ...
    <section class="info-panel">
      <div class="info-panel__container">
        <div class="info-panel__container--text">Soon we will stop supporting old campaigns. Adding prospects will work only for the IF-campaigns.</div>
        <div class="info-panel__container--arrow"></div>
        <a href="https://app.woodpecker.co" target="_blank" class="info-panel__container--button">go to app</a>
      </div>
    </section>
