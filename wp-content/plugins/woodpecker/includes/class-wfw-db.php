<?php
  ...
  class WfwUpdateDatabase {
    ...
    public function __construct($databaseVersion = array()) {
        ...
        if ($databaseVersion != '2.0.0' && $databaseVersion != '2.0.1') {
    ...
    private function update_2_0_1_version() {
      ...
      $wpdb->query("ALTER TABLE " . $wpdb->prefix . "wfw_forms_prospects ADD linkedin_url varchar(255) NOT NULL");
      update_option('wfw_db_version', $this->pluginVersion);
    }
